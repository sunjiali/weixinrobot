...
<%
		...
		list = MySQLUtil.findAllChat();
		for(Chat chat : list){
			%>
			<div class="talk_recordboxme">
				<div class="user"><img src="images/thumbs/15.jpg"/>用户</div>
				<div class="talk_recordtextbg">&nbsp;</div>
				<div class="talk_recordtext">
					<h3><%=chat.getReq_msg()%></h3>
					<span class="talk_time"><%=chat.getCreate_time() %></span>
				</div>
			</div>
			
			<div class="talk_recordbox">
				<div class="user"><img src="images/thumbs/12.jpg"/>PCE族</div>
				<div class="talk_recordtextbg">&nbsp;</div>
				<div class="talk_recordtext">
					<h3><%=chat.getResp_msg() %></h3>
					<span class="talk_time"><%=chat.getCreate_time() %></span>
				</div>
			</div>
			<% 
