<%@page import="org.liufeng.course.pojo.OrderSearch"%>
<%@page import="org.liufeng.course.pojo.Chat"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.List"%>
<%@page import="java.sql.Connection"%>
<%@page import="java.sql.ResultSet"%>
<%@page import="java.sql.PreparedStatement"%>
<%@page import="org.liufeng.course.util.MySQLUtil"%>
...
<br>
<div class="talk">
	<div class="talk_title"><span>聊天记录</span></div>
...
<%
		...
		list = MySQLUtil.findAllSearchList();
		for(OrderSearch orderSearch : list){
			%>
			<div class="talk_recordboxme">
				<div class="user"><img src="images/thumbs/15.jpg"/>快递公司</div>
				<div class="talk_recordtextbg">&nbsp;</div>
				<div class="talk_recordtext">
					<h3><%=orderSearch.getReq_express() %></h3>
					<span class="talk_time"><%=orderSearch.getCreate_time() %></span>
				</div>
			</div>
			
			<div class="talk_recordbox">
				<div class="user"><img src="images/thumbs/11.jpg"/>订单号</div>
				<div class="talk_recordtextbg">&nbsp;</div>
				<div class="talk_recordtext">
					<h3><%=orderSearch.getReq_order() %></h3>
					<span class="talk_time"><%=orderSearch.getCreate_time() %></span>
				</div>
			</div>
			<% 
