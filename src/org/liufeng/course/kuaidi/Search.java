...
public class Search {
	...
	public String search(String content) {
		...
		return "对不起！您输入有误！请输入对应的信息：如需闲聊请回复任意文字，如需查询快递请回复 快递名称+快递单号 （如：zhaijisong+4913588568）";
	}

	public static void main(String[] args) {
		long start = System.currentTimeMillis();
		System.out.println(new Search().search("邮政小包+9976616915749"));
		long end = System.currentTimeMillis();

		System.out.println(new Search().search("哈哈"));
