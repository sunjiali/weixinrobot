...
public class ChatService {
	 ...
	 * @return
	 */
	public static String chatting(String openId, String createTime, String question) throws IOException{
		String answer = null;
		int chatCategory = 0;
		 String APIKEY = "ca75c74747a16455c19ace37b4d22209"; 
		    ...
		    try {
				...
				if(jsonObject.getString("code").equals("200000")){
					answer += "<a href="+'"'+jsonObject.getString("url")+'"'+">"+jsonObject.getString("url")+"</a> ";
				}
		    ...
		    MySQLUtil.saveChatLog(openId, time, question, answer, chatCategory);
		return sb.toString();
